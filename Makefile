...
# Template: app
# Command: D:\Programs\qt\5.9.1\mingw53_32\bin\qmake.exe -o Makefile elasticnodes.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: elasticnodes.pro ../../5.9.1/mingw53_32/mkspecs/win32-g++/qmake.conf ../../5.9.1/mingw53_32/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile elasticnodes.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
